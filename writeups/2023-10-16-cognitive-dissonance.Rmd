...
So cognitive dissonance was decreased by $1966.01-1376.95 ≈ 589$ bits. Or in other words, 589 bits of information was gained.

The table below shows how relative cognitive dissonance falls as users change upvotes to downvotes, reaching zero when $p=q_t$ and thus $upvotes=p×votesTotal=200$.
...
Focusing attention on posts and notes that maximize the rate of reduction of cognitive dissonance is the overall goal of the global brain algorithm. See the next document on [information value](information-value.html).

--- 
# title: "Introduction to the Global Brain Algorithm"
...
We represent the basic UI and interactive handles with the following visual primitives:
...
The theory and math for calculating cross-entropy and ranking posts based on their potential to reduce cross-entropy is developed in [Cognitive Dissonance and Information Rate](cognitive-dissonance-and-information-rate.html). 

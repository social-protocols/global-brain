# Estimating Upvote Rates {#estimating-upvote-rates}
...
A naive solution would be to just take the sample upvote rate or **the plain average vote** as introduced
above at any point in time $t$:

...
Other services do this too, but usually the discussion tree is simply cut on the first level of depth, with a cue prompting users to "show replies". We do not simply cut at the first level which raises the question:

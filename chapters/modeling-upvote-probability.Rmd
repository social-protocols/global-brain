...
Upvote probility is modeled as a Beta distribution and we want a point estimate for $p$ which will give us an estimate.
...
Then $\sum_{i=1}^n{x_i}$ is the *number of upvotes* and $n = upvotes + downvotes$ is the *total number of votes*.

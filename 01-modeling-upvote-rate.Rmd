...
The basic form of content users can provide on the Y platform is a post.
...
Users on Y can rate content by adding an **upvote** or a **downvote**.
There are two essential forms of content users can rate:
posts and posts with a note.
We call those units *Rateable Units of Information* (RUI).
For each RUI, we keep a tally of upvotes and downvotes.

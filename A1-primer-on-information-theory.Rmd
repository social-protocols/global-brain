...
# A Primer on Information Theory I
...
Note that for all the concepts introduced below, we will only discuss the case of **discrete probability distributions** because that's enough for our purposes.
